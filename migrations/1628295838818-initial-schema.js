...
module.exports = class initialSchema1628295838818 {
    name = 'initialSchema1628295838818'

    async up(queryRunner) {
        await queryRunner.query(`CREATE TABLE "user" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "admin" boolean NOT NULL, "email" varchar NOT NULL DEFAULT (1), "password" varchar NOT NULL)`);
